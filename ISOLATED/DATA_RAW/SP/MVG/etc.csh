...
mpirun -np $NSLOTS pp.x -inp INPUT_MVG-pp-up.in | tee OUTPUT_MVG-pp-up
mpirun -np $NSLOTS pp.x -inp INPUT_MVG-pp-dn.in | tee OUTPUT_MVG-pp-dn
# bader
...
# bands2
mpirun -np $NSLOTS bands.x -inp INPUT_MVG-bands2-up.in | tee OUTPUT_MVG-bands2-up
mpirun -np $NSLOTS bands.x -inp INPUT_MVG-bands2-dn.in | tee OUTPUT_MVG-bands2-dn
