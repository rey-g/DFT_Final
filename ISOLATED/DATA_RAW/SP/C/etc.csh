...
mpirun -np $NSLOTS pp.x -inp INPUT_C-pp-up.in | tee OUTPUT_C-pp-up
mpirun -np $NSLOTS pp.x -inp INPUT_C-pp-dn.in | tee OUTPUT_C-pp-dn
# bader
...
# bands2
mpirun -np $NSLOTS bands.x -inp INPUT_C-bands2-up.in | tee OUTPUT_C-bands2-up
mpirun -np $NSLOTS bands.x -inp INPUT_C-bands2-dn.in | tee OUTPUT_C-bands2-dn
