...
mpirun -np $NSLOTS pp.x -inp INPUT_H2-pp-up.in | tee OUTPUT_H2-pp-up
mpirun -np $NSLOTS pp.x -inp INPUT_H2-pp-dn.in | tee OUTPUT_H2-pp-dn
# bader
...
# bands2
mpirun -np $NSLOTS bands.x -inp INPUT_H2-bands2-up.in | tee OUTPUT_H2-bands2-up
mpirun -np $NSLOTS bands.x -inp INPUT_H2-bands2-dn.in | tee OUTPUT_H2-bands2-dn
