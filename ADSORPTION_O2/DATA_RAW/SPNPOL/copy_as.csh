...
copy_as (){
	...
	cp *scf.in ../../../G${X}_${g}_as/$i/$j/INPUT_ADS_G${X}_${g}t${sl}-${j///}-scf.in
	cp *scf.in ../../../G${X}_${g}_as/$i/$j/INPUT_SUBS_G${X}_${g}t${sl}-${j///}-scf.in
	
	cp *pp-up.in ../../../G${X}_${g}_as/$i/$j/INPUT_ADS_G${X}_${g}t${sl}-${j///}-pp-up.in
	cp *pp-up.in ../../../G${X}_${g}_as/$i/$j/INPUT_SUBS_G${X}_${g}t${sl}-${j///}-pp-up.in
	
	cp *pp-dn.in ../../../G${X}_${g}_as/$i/$j/INPUT_ADS_G${X}_${g}t${sl}-${j///}-pp-dn.in
	cp *pp-dn.in ../../../G${X}_${g}_as/$i/$j/INPUT_SUBS_G${X}_${g}t${sl}-${j///}-pp-dn.in
}
...
edit_as (){
	...
	sed -i -e 's/nat = 33/nat = 31/g' *SUBS*scf.in
	...
	sed -i -e 's/nat = 33/nat = 2/g' *ADS*scf.in
...
# ADS
mpirun -np \$NSLOTS pw.x -inp INPUT_ADS_G${X}_${g}t${sl}-${j///}-scf.in >  OUTPUT_ADS_G${X}_${g}t${sl}-${j///}-scf
mpirun -np \$NSLOTS pp.x -inp INPUT_ADS_G${X}_${g}t${sl}-${j///}-pp-up.in >  OUTPUT_ADS_G${X}_${g}t${sl}-${j///}-pp-up
mpirun -np \$NSLOTS pp.x -inp INPUT_ADS_G${X}_${g}t${sl}-${j///}-pp-dn.in >  OUTPUT_ADS_G${X}_${g}t${sl}-${j///}-pp-dn
rm -r tmp_ads/

# SUBS
mpirun -np \$NSLOTS pw.x -inp INPUT_SUBS_G${X}_${g}t${sl}-${j///}-scf.in >  OUTPUT_SUBS_G${X}_${g}t${sl}-${j///}-scf
mpirun -np \$NSLOTS pp.x -inp INPUT_SUBS_G${X}_${g}t${sl}-${j///}-pp-up.in >  OUTPUT_SUBS_G${X}_${g}t${sl}-${j///}-pp-up
mpirun -np \$NSLOTS pp.x -inp INPUT_SUBS_G${X}_${g}t${sl}-${j///}-pp-dn.in >  OUTPUT_SUBS_G${X}_${g}t${sl}-${j///}-pp-dn
rm -r tmp_subs/\n" > etc2.csh
}
