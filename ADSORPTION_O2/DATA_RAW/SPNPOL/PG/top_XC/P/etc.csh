...
# scf
mpirun -np $NSLOTS pw.x -inp INPUT_PG_txc-P-scf.in > OUTPUT_PG_txc-P-scf
# pp
mpirun -np $NSLOTS pp.x -inp INPUT_PG_txc-P-pp.in > OUTPUT_PG_txc-P-pp
mpirun -np $NSLOTS pp.x -inp INPUT_PG_txc-P-pp-up.in > OUTPUT_PG_txc-P-pp-up
mpirun -np $NSLOTS pp.x -inp INPUT_PG_txc-P-pp-dn.in > OUTPUT_PG_txc-P-pp-dn
# bader
mpirun -np $NSLOTS pp.x -inp INPUT_PG_txc-P-bader.in > OUTPUT_PG_txc-P-bader
